...
public class EnemyController : MonoBehaviour
{
    ...
    //public GameObject target = attack_Point;
    ...
    void Awake() {
       ...
       // target = GetComponent<EnemyAnimator>();
        //target = FindWithTag(attack_Point).transform; //GameObject.FindWithTag("Player").transform;
